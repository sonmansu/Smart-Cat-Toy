 ...
 * by Alan Wang
 */
 //node mcu rc car 코드를 우리 상황에 맞게 수정함

#include <ESP8266WiFi.h>
#include <ESP8266WebServer.h>

// WiFi settings
//#define SSID_AP            "KT_GiGA_2G_sumin" // AP server name
//#define PASSWORD_AP        "sumin78900"         // AP server password
// WiFi settings
...
#define RIGHT_MOTOR_PIN1  D6                   // pin 1 of right motor (D2)
#define RIGHT_MOTOR_PIN2  D7                  // pin 2 of right motor (D1)
#define LEFT_MOTOR_PIN1   D8                  // pin 1 of left motor (D6)
#define LEFT_MOTOR_PIN2   D9                  // pin 2 of left motor (D5)
