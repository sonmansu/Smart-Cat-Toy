...
#define LEFT_MOTOR_PIN1   D6                  // 왼쪽모터의 +출력핀
#define LEFT_MOTOR_PIN2   D7                  // 왼쪽모터의 -출력핀
#define RIGHT_MOTOR_PIN1  D8                   // 오른쪽모터의 +출력핀
#define RIGHT_MOTOR_PIN2  D9                  // 왼쪽모터의 -출력핀 
